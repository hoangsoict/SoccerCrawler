 ...
 * @see Soccermatch
 */
public class SoccermatchDAOCustomer  {
		
	public List<Object> searchOverUnderWinResult(final EntityManager em,final String mode, final BigDecimal currentTotalLine,
		...
		final List<Long> winList = countingOverUnders(em, (short) 1, mode, currentTotalLine, openTotalLine,
				currentOuOddsTeam1, openOuOddsTeam1, currentOuOddsTeam2, openOuOddsTeam2);
		final List<Long> lossList = countingOverUnders(em, (short) -1, mode, currentTotalLine, openTotalLine,
				currentOuOddsTeam1, openOuOddsTeam1, currentOuOddsTeam2, openOuOddsTeam2);
		final long win = winList.get(0);
		final long loss = lossList.get(0);

		Short winPercent = 100;
		if ((win + loss) != 0) {
			winPercent = (short) ((win * 100) / (win + loss));
		} else {
			winPercent = -1;
		}
		final Long total = win + loss;
		final List<Object> result = new ArrayList<>();
		result.add(winPercent);
		result.add(total);
		return result;

	}

	public List<Object> searchSpreadOddsWinResult(final EntityManager em,final String mode, final BigDecimal currentSpreadTeam1,
		...
		final List<Long> winList = countingSpreadOdds(em, (short) 1, mode, currentSpreadTeam1, currentOddsTeam1,
				openSpreadTeam1, openOddsTeam1, currentSpreadTeam2, currentOddsTeam2, openSpreadTeam2, openOddsTeam2);
		final List<Long> lossList = countingSpreadOdds(em, (short) -1, mode, currentSpreadTeam1, currentOddsTeam1,
				openSpreadTeam1, openOddsTeam1, currentSpreadTeam2, currentOddsTeam2, openSpreadTeam2, openOddsTeam2);
	...
	public List<Long> countingSpreadOdds(final EntityManager em, final Short flag, final String mode, final BigDecimal currentSpreadTeam1,
			final BigDecimal currentOddsTeam1, final BigDecimal openSpreadTeam1, final BigDecimal openOddsTeam1,
			final BigDecimal currentSpreadTeam2, final BigDecimal currentOddsTeam2, final BigDecimal openSpreadTeam2,
			final BigDecimal openOddsTeam2) {
	...
	public List<Long> countingOverUnders(final EntityManager em ,final Short flag, final String mode, final BigDecimal currentTotalLine,
			final BigDecimal openTotalLine, final BigDecimal currentOuOddsTeam1, final BigDecimal openOuOddsTeam1,
			final BigDecimal currentOuOddsTeam2, final BigDecimal openOuOddsTeam2) {
