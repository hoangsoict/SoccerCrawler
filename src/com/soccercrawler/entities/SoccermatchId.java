 ...
 */
@Embeddable
public class SoccermatchId implements java.io.Serializable {

	private long id;
	private String mode;

	public SoccermatchId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SoccermatchId))
			return false;
		SoccermatchId castOther = (SoccermatchId) other;
