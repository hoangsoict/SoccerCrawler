...
import com.soccercrawler.dal.SoccermatchTempDAO;
 ...
 * SoccermatchTemp
 */
@DAO(daoClass = SoccermatchTempDAO.class)
@Caption("{%mode}")
@Entity
@Table(name = "soccermatch_temp", catalog = "soccerdb")
public class SoccermatchTemp implements java.io.Serializable {
	...
	private Short spreadBetWinPercent;
	private Short ouBetWinPercent;
	private BigDecimal spreadBetTotalCount;
	private BigDecimal ouBetTotalCount;
	...
	@Caption("SpreadBetWinPercent")
	@Column(name = "SPREAD_BET_WIN_PERCENT", columnDefinition = "TINYINT")
	public Short getSpreadBetWinPercent() {
		return this.spreadBetWinPercent;
	}

	public void setSpreadBetWinPercent(Short spreadBetWinPercent) {
		this.spreadBetWinPercent = spreadBetWinPercent;
	}

	@Caption("OuBetWinPercent")
	@Column(name = "OU_BET_WIN_PERCENT", columnDefinition = "TINYINT")
	public Short getOuBetWinPercent() {
		return this.ouBetWinPercent;
	}

	public void setOuBetWinPercent(Short ouBetWinPercent) {
		this.ouBetWinPercent = ouBetWinPercent;
	}

	@Caption("SpreadBetTotalCount")
	@Column(name = "SPREAD_BET_TOTAL_COUNT", columnDefinition = "DECIMAL", precision = 6, scale = 3)
	public BigDecimal getSpreadBetTotalCount() {
		return this.spreadBetTotalCount;
	}

	public void setSpreadBetTotalCount(BigDecimal spreadBetTotalCount) {
		this.spreadBetTotalCount = spreadBetTotalCount;
	}

	@Caption("OuBetTotalCount")
	@Column(name = "OU_BET_TOTAL_COUNT", columnDefinition = "DECIMAL", precision = 6, scale = 3)
	public BigDecimal getOuBetTotalCount() {
		return this.ouBetTotalCount;
	}

	public void setOuBetTotalCount(BigDecimal ouBetTotalCount) {
		this.ouBetTotalCount = ouBetTotalCount;
	}
